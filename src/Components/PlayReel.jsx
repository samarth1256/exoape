...
const PlayReel = () => {
  ...
  return (
    <div ref={parent} className='w-full h-screen overflow-hidden relative bg-black '>
        <div ref={videodiv} className='w-40 aspect-video  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 absolute'>
            <video className='opacity-[0.5] w-full h-full scale-[2] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 absolute' autoPlay muted loop src='https://player.vimeo.com/progressive_redirect/playback/914803778/rendition/1080p/file.mp4?loc=external&log_user=0&signature=5344c0e4fea63ca54bb433621ca0be7b9470b475583fa68b26de2b6e380a390a'></video>
        </div>
      <div className='absolute overlay w-full h-full  text-white flex flex-col justify-between py-20'>
        ...
        <p className='text-center px-10 text-sm'>Our work is best experienced in motion. Don’t forget to put on your headphones.</p>
